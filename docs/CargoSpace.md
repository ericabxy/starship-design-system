...
Some ships are constructed to function as [FTL tugs or tenders](FtlTugTender), able to "tow" another ship that otherwise cannot enter FTL space. The oversize FTL drive systems required for this capability take up cargo space just like passenger and cargo holds.
