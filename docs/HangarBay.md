...
__Threshold checks:__ Each individual bay is rolled for as a separate system during threshold checks. Any craft inside a bay lost in this way are also destroyed or lost.

__Cost for interface craft:__ 2 points per MASS of craft e.g. the two MASS 4 dropships above cost 16 points total.

Cost for a hangar bay itself is paid separately from the interface craft.
